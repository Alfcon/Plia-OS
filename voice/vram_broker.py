...
class VRAMBroker:
    ...
    def notify_active(self, name: str) -> None:
        """Mark an externally-managed model (e.g. Ollama, a separate process)
        as resident on the GPU without running load_fn or evicting anything.
