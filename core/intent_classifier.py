...
_TRAINING: list[tuple[str, str]] = [
    ...
    # respond — social/chitchat/courtesies that need no specialist.
    # Without this class every "thanks/hi" is forced into a task intent or
    # punted to the context-biased LLM router (see supervisor context bleed).
    ("thank you", "respond"),
    ("thank you very much", "respond"),
    ("thanks a lot", "respond"),
    ("thanks", "respond"),
    ("no thank you", "respond"),
    ("hi there", "respond"),
    ("hello", "respond"),
    ("hey", "respond"),
    ("good morning", "respond"),
    ("good night", "respond"),
    ("how are you", "respond"),
    ("nice to meet you", "respond"),
    ("never mind", "respond"),
    ("that's all", "respond"),
    ("ok cool", "respond"),
    ("sounds good", "respond"),
    ("goodbye", "respond"),
    ("see you later", "respond"),
]
